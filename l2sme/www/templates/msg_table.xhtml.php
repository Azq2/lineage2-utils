...
<?php if ($rev): ?>
<div>
	<?= L('У вас файл от новых хроник Lineage II. Поддержка эксперементальная! :)') ?><br />
	<?= L('Если что-то не работает, пишите сюда: ') ?>	<a target="_blank" href="http://zhumarin.ru"><?= L('Контакты для связи') ?></a><br />
</div>
<?php endif; ?>
